                                        ...
                                        <tr>
                                            <td class="border-b border-slate-100 dark:border-slate-700 p-4 pl-8 text-slate-500 dark:text-slate-400">
                                                <div class="text-sm text-gray-900">
                                                    <a href="{{route('offre.show', $candidature->id)}}" class="no-underline hover:underline text-cyan-600 dark:text-cyan-400">{{ $candidature->name }}</a>
                                                </div>
                                            </td>
                                            <td class="border-b border-slate-100 dark:border-slate-700 p-4 pl-8 text-slate-500 dark:text-slate-400">
                                                <div class="text-sm text-gray-900">
                                            ...
                                            <td class="border-b border-slate-100 dark:border-slate-700 p-4 pl-8 text-slate-500 dark:text-slate-400">
                                                <form action="{{ route('offre.destroy', $candidature->id) }}" method="POST">

                                                    
                                                    <a href="{{route('offre.edit', $candidature->id)}}" class="px-4 py-2 text-white mr-4 bg-blue-600">
                                                        {{ __('Accepter') }}
                                                    </a>
                                                    @csrf
                                                    @method('DELETE')
