                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="flex flex-col mt-8">
                        ...
                        <div class="d-print-none with-border mb-8">
                            <a href="{{ route('permission.create') }}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">{{ __('Ajouter une Permission') }}</a>
                        </div>
                        @endcan
                        <div class="py-2">
                                            ...
                                            <td class="border-b border-slate-100 dark:border-slate-700 p-4 pl-8 text-slate-500 dark:text-slate-400">
                                               @can('permission edit')
                                                <form action="{{ route('permission.destroy', $permission->id) }}" method="POST">
                                                    ...
                                                    @endcan
                                                    <!-- <a href="{{route('permission.show', $permission->id)}}" class="px-4 py-2 text-white mr-4 bg-blue-600">
                                                        {{ __('Detail') }}
                                                    </a> -->
